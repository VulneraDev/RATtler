...
class MacOSAppSourceTests(unittest.TestCase):
    def test_bundle_metadata_matches_release(self):
        ...
        self.assertEqual(info["CFBundleShortVersionString"], "0.13.2")
    ...
    def test_download_and_gatekeeper_instructions_are_plain(self):
        ...
        self.assertIn("releases/download/v0.13.2/RATtler-macOS-Apple-Silicon.zip", readme)
        self.assertIn("releases/download/v0.13.2/RATtler-macOS-Intel.zip", readme)
